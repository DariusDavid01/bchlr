...
class AdminUserController extends Controller
{
    public function AllAdminRole(){
        ...
        return view('backend.role.admin_role_all',compact('admin'));
    }
    ...
    $notification = array('message' => 'Admin added successfully',
        'alert-type' =>'success');
    ...
    $notification = array('message' => 'Admin updated successfully',
        'alert-type' =>'info');
    ...
    public function DeleteAdminRole($id){
        ...
        $notification = array('message' => 'Admin deleted successfully',
                'alert-type' =>'info');
