...
<script src="https://kit.fontawesome.com/4797c81eed.js" crossorigin="anonymous"></script>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="card" style="width: 18rem;">
          <img src="" class="card-img-top" alt="..." style="height:200px; width:175px" id="pimage">
      </div>
      </div>
      <div class="col-md-4">
      <ul class="list-group">
        ...
        <li class="list-group-item">Stock: <span class="badge badge-pill badge-success" id="available" style="background:green; color:white"></span><span class="badge badge-pill badge-danger" id="stockout" style="background:red; color:white"></span></li>
      </ul>
      </div>
      <div class="col-md-4">
    ...
    <select class="form-control" id="color" name="color">
      ...
      <div class="col-md-4">
      <div class="form-group">
    <label for="size" id="sizeArea">Choose size</label>
  ...
  <button type="submit" class="btn btn-primary mb-2" onclick="addToCart()">@if(session()->get('language') == 'romanian') Adauga in cos @else Add to cart @endif</button>
      </div>
    ...
    function wishlist(){
      $.ajax({
        ...
        success:function(response){
          ...
          <button data-toggle="modal" data-target="#exampleModal"  id="${value.product_id}" onclick="productView(this.id)" class="btn btn-primary icon" type="button" title="Adauda in cos"> Adauga in cos </button> 
          @else 
          <button data-toggle="modal" data-target="#exampleModal"  id="${value.product_id}" onclick="productView(this.id)" class="btn btn-primary icon" type="button" title="Add Cart"> Add to cart </button> @endif
