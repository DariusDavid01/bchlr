          ...
          <div class="item">
            ...
            <div class="container-fluid">
              <div class="caption vertical-top text-left">
                <div class="big-text"> @if(session()->get('language') == 'romanian') Reduceri Mari @else Big Sale @endif </div>
                <div class="excerpt hidden-sm hidden-md"> @if(session()->get('language') == 'romanian') Economiseste pana la 49% @else Save up to 49% off @endif </div>
                <div class="excerpt-normal hidden-sm hidden-md"> @if(session()->get('language') == 'romanian') Doar aici, si acum @else Only now, and here @endif </div>
              </div>
              <!-- /.caption --> 
            </div>
            <!-- /.container-fluid --> 
