						...
						<tbody>
							...
							<tr>
								...
								<td width="30%"><a href="{{route('subcategory.edit',$item->id)}}" class="btn btn-info" title="Edit Data"><i class="fa fa-pencil"></i></a>
                                    <a href="{{route('subcategory.delete',$item->id)}}" class="btn btn-danger" title="Delete Data" id="delete"><i class="fa fa-trash"></i></a></td>
							</tr>
							@endforeach
						</tbody>
					  </table>
   ...
   <div class="box-body">
       ...
       <form method="post" action="{{route('subcategory.store')}}">
               ...
               <div class="form-group">
                   ...
                   <div class="form-group">
                       <h5>SubCategory Name Romanian <span class="text-danger">*</span></h5>
                       <div class="controls">
