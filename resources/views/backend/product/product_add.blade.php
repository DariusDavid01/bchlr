            ...
            <div class="row">
                <div class="col-12">	
                    ...
                    <div class="row"> <!-- start 4th row -->
                        ...
                        <div class="controls">
                            <input type="text" name="product_tags_ro" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">
                        ...
                        <div class="controls">
                            <input type="text" name="product_size_ro" class="form-control" value="Small,Medium,Large" data-role="tagsinput" required="">
                    ...
                    <div class="row"> <!-- start 5th row -->
                        ...
                        <div class="controls">
                            <input type="text" name="product_color_ro" class="form-control" value="Rosu,Negru,Large" data-role="tagsinput" required="">
                    ...
                    <div class="row"> <!-- start 7th row -->
                        ...
                        <div class="controls">
                            <textarea name="short_descp_en" id="textarea" class="form-control" required="" placeholder="Short description in english"></textarea>
                        </div>
                        </div>
                        </div> <!-- end col md 6 -->
                        ...
                        <div class="controls">
                            <textarea name="short_descp_ro" id="textarea" class="form-control" required="" placeholder="Short description in romanian"></textarea>
                        </div>
                        </div>
                        </div> <!-- end col md 6 -->
                    ...
                    <div class="row"> <!-- start 8th row -->
                        ...
                        <div class="controls">
                            <textarea name="long_descp_en" id="editor1" rows="10" cols="80" required="">Long description in english</textarea>
                        </div>
                        </div>
                        </div> <!-- end col md 6 -->
                        ...
                        <div class="controls">
                            <textarea name="long_descp_ro" id="editor2" rows="10" cols="80" required="">Long description in romanian</textarea>
                        </div>
                        </div>
                        </div> <!-- end col md 6 -->
                ...
                <div class="text-xs-right">
                    <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Add Product"></button>
                </div>
            </form>
