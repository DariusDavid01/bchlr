           ...
           <form method="post" action="{{route('update.seosetting')}}" >
             ...
             <div class="col-12">	
                   ...
                   <div class="form-group">
                       ...
                       <div class="controls">
                           <textarea name="meta_description" id="textarea" class="form-control" required placeholder="Meta description">{{$seo->meta_description}}</textarea>
                   </div>
                   </div>      
                   <div class="form-group">
                       <h5>Google analytics <span class="text-danger">*</span></h5>
                       <div class="controls">
                           <textarea name="google_analytics" id="textarea" class="form-control" required placeholder="Google analytics">{{$seo->google_analytics}}</textarea>
                   </div>
                           </div>
                       </div>
               </div>
