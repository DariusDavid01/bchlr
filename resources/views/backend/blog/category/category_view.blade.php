						...
						<tbody>
							...
							<tr>
								...
								<td><a href="{{route('blog.category.edit',$item->id)}}" class="btn btn-info" title="Edit Data"><i class="fa fa-pencil"></i></a>
                                    <a href="{{route('blog.category.delete',$item->id)}}" class="btn btn-danger" title="Delete Data" id="delete"><i class="fa fa-trash"></i></a></td>
							</tr>
							@endforeach
						</tbody>
					  </table>
               ...
               @csrf
                       ...
                       <div class="controls">
						...
						@enderror
                           ...
                           <div class="form-group">
                       <h5>Blog category name Romanian <span class="text-danger">*</span></h5>
                       <div class="controls">
