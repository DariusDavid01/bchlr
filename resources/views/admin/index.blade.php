...
$month = date('F');
$year = date('Y');
$month = App\Models\Order::where('order_month',$month)->where('order_year',$year)->sum('amount');
...
$totalorders = App\Models\Order::all();
@endphp
			...
			<div class="row">
				<div class="col-xl-3 col-6">
                    ...
                    <div>
                        ...
                        <h3 class="text-white mb-0 font-weight-500">$ {{$today}} <small class="text-success"> USD</small></h3>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="box overflow-hidden pull-up">
                <div class="box-body">							
                    ...
                    <div>
                        ...
                        <h3 class="text-white mb-0 font-weight-500">$ {{$month}} <small class="text-success"> USD</small></h3>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="box overflow-hidden pull-up">
                <div class="box-body">							
                    ...
                    <div>
                        ...
                        <h3 class="text-white mb-0 font-weight-500">$ {{$year}} <small class="text-success"> USD</small></h3>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="box overflow-hidden pull-up">
                <div class="box-body">							
                    ...
                    <div>
                        ...
                        <h3 class="text-white mb-0 font-weight-500">{{count($pending)}} <small class="text-danger"> orders</small></h3>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="box">
                <div class="box-header">
                    <h4 class="box-title align-items-start flex-column">
                        All recent orders
                        <small class="subtitle">From the total of: {{count($totalorders)}} orders</small>
                    </h4>
                </div>
                @php 
