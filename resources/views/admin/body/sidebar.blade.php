...
@endphp
 <aside class="main-sidebar">
    ...
    <li class="treeview {{($prefix == '/return')? 'active':''}}" ">
      ...
      <ul class="treeview-menu">
        <li class="{{($route == 'return.request')? 'active':''}}"><a href="{{ route('return.request') }}"><i class="ti-more"></i>Return requests</a></li>
...
<li class="treeview {{($prefix == '/adminuserrole')? 'active':''}}" ">
  ...
  <ul class="treeview-menu">
    <li class="{{($route == 'all.admin.users')? 'active':''}}"><a href="{{ route('all.admin.users') }}"><i class="ti-more"></i>Admin users</a></li>
    </ul>
</li> 
		  @else
      @endif
